...
CNtlPacket::CNtlPacket(CNtlPacket * rhs)
{
	...
	memcpy(this, rhs, sizeof(CNtlPacket));
}
/*
///-----------------------------------------------------------------------------------
//		Purpose	:
...
{
	WriteData((void *)arg, (int)sizeof(arg));
...
CNtlPacket & CNtlPacket::operator >>(LPTSTR arg)
{
	ReadData((void*)arg, (int)sizeof((LPTSTR)m_pReadDataPos));
...
//		Return	:
//-----------------------------------------------------------------------------------
CNtlPacket& CNtlPacket::operator <<(unsigned long arg)
{
	WriteData(&arg, sizeof(unsigned long));
...
CNtlPacket & CNtlPacket::operator >>(unsigned long& arg)
{
	ReadData(&arg, sizeof(unsigned long));
