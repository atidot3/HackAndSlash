...
//		Return	:
//-----------------------------------------------------------------------------------
unsigned long Encrypt(void* pvOriginalString, unsigned long dwOriginalLength, void* pvBuffer, unsigned long dwBufferSize)
{
#ifdef _DEVEL
	...
	unsigned long dwCurrentOffset = 0;
...
//		Return	:
//-----------------------------------------------------------------------------------
unsigned long Decrypt(void* pvOriginalString, unsigned long dwOriginalLength, void* pvBuffer, unsigned long dwBufferSize)
{
...
bool EncryptUnitTest()
{
	...
	unsigned long dwWrittenBytes = Encrypt(szOriginalString, (unsigned long)(strlen(szOriginalString)), szEncryptedString, sizeof(szEncryptedString));
	if (0 == dwWrittenBytes)
	{
