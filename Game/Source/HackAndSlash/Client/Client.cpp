...
void AClient::KickPlayerFromGroup(int32 charID)
{
	UE_LOG(LogInit, Log, TEXT("charid = %d"), charID);
	HackAndSlash::instance->KickPlayer(charID);
}
void AClient::DoIamLeader(const bool &value)
{

}
void AClient::SendWorldMessage(FString message)
{
	HackAndSlash::instance->SendWorldMessage(message);
}