...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `AuthLogin`(IN m_szUserID VARCHAR(20), IN m_szUserPW VARCHAR(20), OUT m_dwAccountID INT, OUT m_nResultCode INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `BuyItemFromShop`(IN tblidx INT, IN CharID INT, IN pos INT,IN rank INT, IN durability INT, OUT unique_iID INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `CreateItem`(IN tblidx INT, IN CharID INT, IN pos INT,IN Place INT, OUT unique_iID INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `ChangeCharname`(IN awchCharName VARCHAR(16), IN char_Id INT, OUT wResultCode INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `ChangeGuildMaster`(IN characterID INT, IN guildname VARCHAR(30), IN mastercharID INT, OUT wResultCode INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `CharBind`(IN characterID INT, IN bindObjectTblidx INT, OUT currentWorldID INT)
BEGIN
...
-- ----------------------------
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `CharCreate`(IN awchCharName VARCHAR(16), IN byRace INT, IN byClass INT, IN byGender INT, IN byFace INT, IN byHair INT, IN byHairColor INT, IN bySkinColor INT, IN account_id INT, OUT char_id INT, OUT wResultCode INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `DisbandGuild`(IN guild_name VARCHAR(30), IN characterID INT, OUT wResultCode INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `GuildCreate`(IN c_guild_name VARCHAR(30), IN characterID INT, OUT wResultCode INT, OUT cguildid INT, OUT charactername VARCHAR(30))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `GuildInfo`(IN characterID INT, OUT guild_id INT, OUT guild_name VARCHAR(30), OUT guild_master INT, OUT guild_notice VARCHAR(256), OUT guild_rep INT, OUT second_guild_master INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `KickGuild`(IN characterID INT, OUT wResultCode INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `LeaveGuild`(IN characterID INT, OUT wResultCode INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `NewSecondGuildMaster`(IN characterID INT, IN guild_name VARCHAR(30), OUT wResultCode INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`dbo`@`localhost` PROCEDURE `UpdateGuildNotice`(IN characterID INT,  IN awchNotice VARCHAR(256), OUT wResultCode INT)
BEGIN
