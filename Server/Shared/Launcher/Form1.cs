...
namespace AKCore_Launcher
{
    public partial class Form1 : Form
    {
        ...
        {
            string[] processes = new string[] { "UwAmp", "AuthServer", "CharServer", "ChatServer", "GameServer" };
        ...
        private void btnDatabase_Click(object sender, EventArgs e)
        {
            ...
            {
                foreach (var process in Process.GetProcessesByName("UwAmp"))
                {
                    process.Kill();
                }
            }
